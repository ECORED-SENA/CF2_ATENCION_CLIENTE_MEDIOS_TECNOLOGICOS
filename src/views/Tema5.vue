...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row
      .col-md-5
        h5(data-aos="fade-left") Los PQRSDF son una herramienta que permite desarrollar protocolos que ayudan a dar solución de forma ordenada a las necesidades e inconvenientes que un cliente o persona pueda tener con respecto a los productos o servicios de una empresa e institución.
      .col-md-7
        p(data-aos="fade-right") En otras palabras, hace referencia al proceso por el cual una empresa o institución gestiona las peticiones, quejas, reclamos, sugerencias, denuncias o felicitaciones que realizan las personas o clientes. 
        p.mt-4(data-aos="fade-right") Hablando en términos generales, esta actividad hace parte del proceso de servicio al cliente que responden las necesidades más importantes del consumidor:
    ...
    ImagenInfografica.color-secundario.mt-5.col-md-9.m-auto
      ...
      .tarjeta.color-acento-botones.p-3(x="91%" y="72%" numero="06" style="background-color:#F6F6F6;border-radius:0px;")
        .h5 Felicitación
        p Manifestación de agradecimiento, satisfacción hacia los productos, servicios, programas y/o servidores de la entidad.

    p.mt-5(data-aos="fade-up") Desde la parte normativa, en Colombia se parte de la Constitución Política de 1992 con:

    ol.lista-ol--cuadro.lista-ol--separador.mt-5
      li(data-aos="fade-up")
        .lista-ol--cuadro__vineta
          span 1
        p #[strong Artículo 23.] Toda persona tiene derecho a presentar peticiones respetuosas a las autoridades por motivos de interés general o particular y a obtener pronta resolución. #[br] El legislador podrá reglamentar su ejercicio ante organizaciones privadas para garantizar los derechos fundamentales.
      li(data-aos="fade-up")
        .lista-ol--cuadro__vineta
          span 2
      ...
      li(data-aos="fade-up")
        .lista-ol--cuadro__vineta
          span 5
        p #[strong Ley 1266 de diciembre de 2008.] Por la cual se dictan las disposiciones generales del Hábeas Data y se regula el manejo de la información contenida en bases de datos personales.
      li(data-aos="fade-up")
        .lista-ol--cuadro__vineta
          span 6
      ...
      li(data-aos="fade-up")
        .lista-ol--cuadro__vineta
          span 9
        p Sentencia Corte Constitucional C-951/2014. M.P. Martha Victoria Sáchica Méndez.
    ...
    .row.mt-5.p-4(style="background-color:#FFDE96;")
      ...
      .col-md-7.col-lg-7.col-sm-6(style="place-self:center;")
        p(data-aos="fade-up") Para ampliar un poco más sobre la normativa, se pueden consultar los siguientes documentos: Criterios Normativos para PQRSDF. #[strong ¡Pilas con las PQRSDF!]
