  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    ImagenInfografica.color-secundario.mt-5.col-md-7.m-auto
      ...
      .tarjeta.color-acento-botones.p-3(x="1%" y="61%" numero="02" style="background-color:#F6F6F6;border-radius:0px;")
        p.mb-0 Se deben identificar los puntos fuertes, críticos y de mejora.
    ...
    .row.mb-4.justify-content-center.mt-5
      .col-sm-6.col-xl-3.mb-4.mb-xl-0(data-aos="zoom-in")
        .tarjeta.tarjeta-slide.arriba.color-acento-contenido(@mouseover="indicadorTarjetaSlide = false" style="background-color:#FADE9F;border-radius:0px;")
    ...
    p.mt-5(data-aos="fade-up") A continuación, se mencionan algunos métodos e instrumentos de información que nos permiten realizar un seguimiento efectivo a la satisfacción de cada cliente. 
...
.tarjeta-slide.color-acento-contenido .tarjeta-slide__img
